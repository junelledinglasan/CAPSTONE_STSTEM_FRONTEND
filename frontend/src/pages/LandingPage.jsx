...
// ─── Mock Announcements (palitan ng real API later) ───────────────────────────
const MOCK_ANNOUNCEMENTS = [
  {
    id:     1,
    type:   "Activity",
    title:  "Annual General Assembly 2026",
    body:   "Matagumpay na naidaos ang ating Annual General Assembly ngayong Marso 15, 2026 sa Lucena City Hall. Maraming salamat sa lahat ng dumalo at sa inyong patuloy na suporta sa LEAF MPC! 🎉",
    author: "Admin",
    date:   "March 15, 2026",
  },
  {
    ...
    body:   "Inaanyayahan ang lahat ng miyembro na dumalo sa aming Financial Literacy Seminar sa Abril 5, 2026, 9:00 AM – 12:00 PM. Libre ang pagpasok. Bring your family! 📚",
    author: "Admin",
    date:   "March 18, 2026",
  },
  {
    ...
    body:   "Paalala sa lahat ng miyembro: Ang schedule ng koleksyon para sa buwan ng Marso ay sa mga araw na 3, 7, 10, 14, 17, 20, 24, at 28. Mangyaring magbayad sa tamang oras.",
    author: "Staff",
    date:   "March 1, 2026",
  },
];
...
export default function LandingPage() {
  ...
  // Use announcements from AuthContext if available, else use mock
        ...
        <div className="lnd-nav-inner">
          ...
          <div className="lnd-nav-actions">
            {canInstall && !installed && (
              <button className="lnd-install-btn" onClick={install}>
                ⬇ Install App
              </button>
            )}
            {installed && (
              <span className="lnd-installed-badge">✓ Installed</span>
            )}
            <button className="lnd-btn-member" onClick={() => navigate("/login")}>
              Member Login
            </button>
            <button className="lnd-btn-office" onClick={() => navigate("/admin-login")}>
              Office Login
            </button>
          </div>
      ...
      <section id="home" className="lnd-hero">
        ...
        <div className="lnd-hero-content">
          ...
          <p className="lnd-hero-sub">
            LEAF Multi-Purpose Cooperative — empowering members through
            accessible financial services, community development, and
            environmental stewardship.
          </p>
          <div className="lnd-hero-btns">
            <button className="lnd-btn-primary" onClick={() => navigate("/register")}>
              Join as Member
            </button>
          ...
          {canInstall && !installed && (
            <div className="lnd-install-strip" onClick={install}>
              <span>⬇</span>
              <div>
                <div className="lnd-install-label">Install LEAF MPC App</div>
                <div className="lnd-install-sub">Available for Android, iOS & Desktop</div>
              </div>
            </div>
          )}
        </div>
          ...
          <div className="lnd-vmc-grid">
            ...
            <div className="lnd-vmc-card">
              ...
              <div className="lnd-vmc-values">
                <div className="lnd-vmc-value-item">
                  <span className="lnd-vmc-letter">L</span>
                  <span>Loyalty and Servant-Leadership</span>
                </div>
                <div className="lnd-vmc-value-item">
                  <span className="lnd-vmc-letter">E</span>
                  <span>Environment</span>
                </div>
                <div className="lnd-vmc-value-item">
                  <span className="lnd-vmc-letter">A</span>
                  <span>Accountability</span>
                </div>
                <div className="lnd-vmc-value-item">
                  <span className="lnd-vmc-letter">F</span>
                  <span>Fairness and Faith</span>
                </div>
              </div>
            </div>
        ...
        <div className="lnd-container">
          ...
          <div className="lnd-services-layout">
            ...
            <div className="lnd-svc-bottom-card">
              <div className="lnd-svc-bottom-item">
                D. Community Services on Environmental Concerns
              </div>
              <div className="lnd-svc-bottom-divider" />
              <div className="lnd-svc-bottom-item">
                E. Livelihood Training on Borloloy
              </div>
              <div className="lnd-svc-bottom-divider" />
              <div className="lnd-svc-bottom-item">
      ...
      <section id="announcements" className="lnd-section lnd-announce">
        <div className="lnd-container">
          ...
          <div className="lnd-announce-note">
            For more announcements, <button className="lnd-inline-link" onClick={() => navigate("/login")}>log in to your member account</button>.
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="lnd-section lnd-contact">
        <div className="lnd-container">
          ...
          <p className="lnd-contact-sub">
            Have questions? Visit our office or reach us through the following.
          </p>
          ...
          <div className="lnd-contact-grid">
            <div className="lnd-contact-card">
              ...
              <div className="lnd-contact-val">
                Lucena City, Quezon Province<br />Philippines
              </div>
            </div>
            <div className="lnd-contact-card">
              <div className="lnd-contact-icon">📞</div>
            ...
            <div className="lnd-contact-card">
              ...
              <div className="lnd-contact-val">
                info@leafmpc.coop<br />support@leafmpc.coop
              </div>
            </div>
            <div className="lnd-contact-card">
              <div className="lnd-contact-icon">🕐</div>
              ...
              <div className="lnd-contact-val">
                Mon–Fri: 8:00 AM – 5:00 PM<br />Sat: 8:00 AM – 12:00 PM
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lnd-container">
          <div className="lnd-footer-inner">
            ...
            <div className="lnd-footer-actions">
              <button className="lnd-btn-member" onClick={() => navigate("/login")}>Member Login</button>
              <button className="lnd-btn-office" onClick={() => navigate("/admin-login")}>Office Login</button>
            </div>
          </div>
